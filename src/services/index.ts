...
const apis = {
  ...
  addFutureEventPositiveMainTag: '/api/event/future_event/add_positive_main_tag',
  removeFutureEventPositiveMainTag: '/api/event/future_event/remove_positive_main_tag',
  addFutureEventNegativeMainTag: '/api/event/future_event/add_negative_main_tag',
  removeFutureEventNegativeMainTag: '/api/event/future_event/remove_negative_main_tag',
  addFutureEventPositiveStockPool: '/api/event/future_event/add_positive_stock_pool',
  removeFutureEventPositiveStockPool: '/api/event/future_event/remove_positive_stock_pool',
  addFutureEventNegativeStockPool: '/api/event/future_event/add_negative_stock_pool',
  removeFutureEventNegativeStockPool: '/api/event/future_event/remove_negative_stock_pool',
